...
<img src="assets/coherence-logo.svg" width={size} height={size} alt="The Coherence Company" />;
  ...
  return (
    <nav className={`nav${scrolled ? " scrolled" : ""}`} style={{ padding: "12px 56px", margin: "0px", opacity: "1", backgroundColor: "rgba(255, 255, 255, 0.5)" }}>
      <div className="nav-brand" onClick={() => onNav("top")}>
        <img src="assets/Logo.png" className="nav-logo" alt="The Coherence Company" style={{ height: "48px" }} />
...
<section className="hero" id="top">
    ...
    style={{
      backgroundImage: "url('assets/backgrounds/calligraphy-30.png')",
    ...
    <div className="container hero-inner">
      ...
      <div className="hero-ctas reveal reveal-3">
        <button className="btn btn-primary btn-lg" onClick={onJoin}>
          Join the SEED <iconify-icon icon="iconoir:arrow-tr" width="16" height="16"></iconify-icon>
        </button>
      ...
      <div className="container">
        ...
        <div className="layer-grid">
          ...
          <article key={l.n} className="layer-card">
              ...
              <div className="layer-icon"><iconify-icon icon={l.icon} width="26" height="26"></iconify-icon></div>
              <h3>{l.title}</h3>
              <p>{l.body}</p>
            </article>
          )}
    ...
    <section className="section journey" id="journey">
      ...
      <div className="container">
        ...
        <div className="journey-callout">
          <div className="journey-callout-icon"><iconify-icon icon="iconoir:spark-solid" width="22" height="22"></iconify-icon></div>
          <div>
